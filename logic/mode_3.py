...
class Mode3:
    ...
    def prepare_user_message(self, text: str, max_output_length: Optional[Dict[str, Union[str, int]]] = None) -> str:
        message = f"""Clean and polish this text while preserving its meaning:\n\n{text}\n\nImprove its structure, grammar, and clarity. Handle any incomplete thoughts or formatting issues. Make it more readable while keeping the original intent."""
